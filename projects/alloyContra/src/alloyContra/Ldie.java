...
public class Ldie extends JFrame{
	...
	///	//被敌人四击中
		/*if(is_enemy_x2&&Enemy1.enemy_bullet_position_x2>=Leadone.leadone_position_x-20&&Enemy1.enemy_bullet_position_x2<=Leadone.leadone_position_x+150&&
				Enemy1.enemy_bullet_position_y2>=Leadone.leadone_position_y-50&&Enemy1.enemy_bullet_position_y2<=Leadone.leadone_position_y+150){
			Background.is_die=true;
			Background.is_enemy_spark=true;
			Enemy1.bullet_e2=0;
		}*/
		//被敌人五击中
		//////此处已转移到Enemy1中的432行
		/*==if(is_enemy_x3&&Enemy1.enemy_bullet_position_x3>=Leadone.leadone_position_x-20&&Enemy1.enemy_bullet_position_x3<=Leadone.leadone_position_x+20&&
				Enemy1.enemy_bullet_position_y3>=Leadone.leadone_position_y-10&&Enemy1.enemy_bullet_position_y3<=Leadone.leadone_position_y+10){
			Background.is_die=true;
			Background.is_enemy_spark=true;
			Enemy1.bullet_e3=0;
		}*/
	...
	public void dieLeadone(Graphics g){
		...
		if(type_die<7){
			if(ci_die<50){
				//死的声音
				if(type_die==0&&ci_die==0){
					Background.music.mc_L_die();			
				}
				ci_die++;
			}else{
				ci_die=0;
